...
/*!**********************************!*\
  !*** ./resources/js/routes.json ***!
  \**********************************/
/*! exports provided: , users.index, users.create, users.store, users.show, users.edit, users.update, users.destroy, welcome, home, first, second, third, fourth, fifth, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"\":\"api/user\",\"users.index\":\"api/users\",\"users.create\":\"api/users/create\",\"users.store\":\"api/users\",\"users.show\":\"api/users/{user}\",\"users.edit\":\"api/users/{user}/edit\",\"users.update\":\"api/users/{user}\",\"users.destroy\":\"api/users/{user}\",\"welcome\":\"/\",\"home\":\"home\",\"first\":\"first/path/method/get\",\"second\":\"second/path/method/post\",\"third\":\"third/path/{param?}/get/method\",\"fourth\":\"fourth/path/{param?}/post/method\",\"fifth\":\"fifth/form/{parameter?}\"}");

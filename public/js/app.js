...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-router */ "./node_modules/vue-router/dist/vue-router.esm.js");
/* harmony import */ var _UsersRouter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UsersRouter */ "./resources/js/UsersRouter.js");
...
Vue.use(vue_router__WEBPACK_IMPORTED_MODULE_0__["default"]); // Logic Launcher

var app = new Vue({
  el: '#app',
  render: function render(widget) {
    return widget(_components_Users_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
  },
  UsersRouter: _UsersRouter__WEBPACK_IMPORTED_MODULE_1__["default"]
});
...
/*!**********************************!*\
  !*** ./resources/js/routes.json ***!
  \**********************************/
/*! exports provided: , users.index, users.create, users.store, users.show, users.edit, users.update, users.destroy, welcome, vue_js, first, second, third, fourth, fifth, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"\":\"api/user\",\"users.index\":\"api/users\",\"users.create\":\"api/users/create\",\"users.store\":\"api/users\",\"users.show\":\"api/users/{user}\",\"users.edit\":\"api/users/{user}/edit\",\"users.update\":\"api/users/{user}\",\"users.destroy\":\"api/users/{user}\",\"welcome\":\"/\",\"vue_js\":\"vue_js\",\"first\":\"first/path/method/get\",\"second\":\"second/path/method/post\",\"third\":\"third/path/{param?}/get/method\",\"fourth\":\"fourth/path/{param?}/post/method\",\"fifth\":\"fifth/form/{parameter?}\"}");
